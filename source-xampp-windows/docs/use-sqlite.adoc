...
Begin by creating and populating a new database using the SQLite command-line client, as below:
 ...
 . Change to the _htdocs\_ subdirectory of your XAMPP installation directory (typically _C:\xampp_) and create a new SQLite database file named _mydb.sq3_ with the SQLite command-line client:
+
 cd C:\xampp\htdocs
 sqlite3 mydb.sq3
+
