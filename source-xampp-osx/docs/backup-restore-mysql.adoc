...
+
 /Applications/XAMPP/bin/mysqldump --user=root --password="" bitnami_wordpress > bitnami_wordpress.sql
+
...
+
 /Applications/XAMPP/bin/mysql --user=root --password="" -e "CREATE DATABASE myblog"
+
...
+
 /Applications/XAMPP/mysql --user=root --password="" --database=myblog < bitnami_wordpress.sql
+
