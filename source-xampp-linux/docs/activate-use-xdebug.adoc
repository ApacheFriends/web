...
To activate Xdebug, follow these steps:
 ...
 . Edit the _php.ini_ file in the _etc/_ subdirectory of your XAMPP installation directory (usually, _/opt/lampp_). Within this file, activate the Xdebug extension by adding the following line to it:
+
 extension = xdebug.so
